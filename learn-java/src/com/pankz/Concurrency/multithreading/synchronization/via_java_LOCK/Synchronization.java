...
import com.pankz.Concurrency.multithreading.synchronization.via_synchronized_keyword.StringReverseThread;
...
public class Synchronization {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread thread1 = new com.pankz.Concurrency.multithreading.synchronization.via_synchronized_keyword.StringReverseThread(list, "HELLO"); //sharing same resources of list
        thread1.start();
